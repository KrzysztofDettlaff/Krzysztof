...
describe('Table a tab E2E Tests', function () {
  ...
  it('should display lowest currency ', function () {
    element(by.id('divTheSmallestCurrencyCode')).getText()
      .then(t => expect(t.length).not.toEqual(0));
    element(by.id('divTheSmallestCurrencyCurrency')).getText()
      .then(t => expect(t.length).not.toEqual(0));
    element(by.id('divTheSmallestCurrencyMid')).getText()
      .then(t => expect(t.length).not.toEqual(0));
  });
